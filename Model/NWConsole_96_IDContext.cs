...
{
    public partial class NWConsole_96_IDContext : DbContext
    {
        public NWConsole_96_IDContext()
        {
        }

        public NWConsole_96_IDContext(DbContextOptions<NWConsole_96_IDContext> options)
            : base(options)
        {
        }
